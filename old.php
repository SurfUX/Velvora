...
<?php include 'header.php'; ?>
  ...
  <div class="col-lg-12">
    <div class="hero-text text-center" data-aos="fade-up" data-aos-delay="100">
      <h1 class="hero-title">Discover Sri Lanka with Velvora Tours</h1>
      <p class="hero-subtitle">
        Experience carefully curated journeys across Sri Lanka — from pristine beaches and lush tea plantations 
        to ancient heritage sites and wildlife safaris. Velvora Tours connects European travelers with unforgettable, 
        authentic and luxury travel experiences, with expanding destinations across the Maldives and Asia.
      </p>
      <div class="hero-buttons">
        <a href="#destinations" class="btn btn-primary me-3">Discover Sri Lanka</a>
        <a href="#packages" class="btn btn-outline">View Travel Packages</a>
      </div>
    </div>
  </div>
</div>
...
<div class="why-choose-section">
  <div class="row justify-content-center">
    <div class="col-lg-8 text-center mb-5" data-aos="fade-up" data-aos-delay="100">
      ...
      <p>
        At Velvora Tours, we create more than holidays — we design immersive travel experiences. 
        Specialising in Sri Lanka with hand-picked partners and expert local knowledge, we ensure every journey is smooth, safe, and truly unforgettable.
      </p>
    </div>
  </div>
  ...
  <div class="row g-4">
    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
      <div class="feature-card">
        ...
        <p>
          Our professional local guides and travel planners offer deep insights into Sri Lanka’s culture, nature, and hidden gems for authentic experiences.
        </p>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="250">
      <div class="feature-card">
        ...
        <p>
          We collaborate with verified hotels, drivers, and activity providers to deliver secure, comfortable, and reliable travel at every step.
        </p>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
      <div class="feature-card">
        ...
        <p>
          Enjoy carefully curated travel packages that balance luxury, comfort, and affordability — giving you outstanding value for money.
        </p>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="350">
      <div class="feature-card">
        ...
        <p>
          Our dedicated travel consultants are available around the clock to assist you before, during, and after your journey.
        </p>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
      <div class="feature-card">
        ...
        <p>
          Starting with Sri Lanka and expanding to the Maldives and beyond, we bring you world-class destinations for every travel style.
        </p>
      </div>
    </div>
    ...
    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="450">
      <div class="feature-card">
        ...
        <p>
          From accommodation to experiences, every detail is thoughtfully arranged to deliver comfort, quality, and memorable moments.
        </p>
      </div>
    </div>
  </div>
            ...
            <div class="featured-destination">
              <div class="destination-overlay">
                ...
                <div class="destination-info">
                  ...
                  <a href="destination-details.php" class="explore-btn">
              ...
              <div class="col-12" data-aos="fade-left" data-aos-delay="300">
                <div class="compact-destination">
                  ...
                  <div class="destination-details">
                    ...
                    <a href="destination-details.php" class="quick-link">View Details <i class="bi bi-chevron-right"></i></a>
                  </div>
                </div>
              </div>
