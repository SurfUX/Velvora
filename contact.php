      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="300">
        <div class="contact-info-box">
          ...
          <div class="info-content">
            ...
            <p>Sunday: Online Support Available</p>
          </div>
        </div>
      </div>
    ...
    <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="300">
      <div class="col-lg-10">
        <div class="contact-form-wrapper">
          <h2 class="text-center mb-4">Plan Your Sri Lanka Trip</h2>
          ...
          <form action="forms/contact.php" method="post" class="php-email-form">
            <div class="row g-3">
              ...
              <div class="col-md-12">
                <div class="form-group">
                  <div class="input-with-icon">
                    ...
                    <input type="text" class="form-control" name="subject" placeholder="Travel Inquiry Subject" required="">
                  </div>
                </div>
              </div>
              ...
              <div class="col-12">
                <div class="form-group">
                  <div class="input-with-icon">
                    ...
                    <textarea class="form-control" name="message" placeholder="Tell us about your travel plans, dates, and preferences..." style="height: 180px" required=""></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12">
                ...
                <div class="sent-message">Thank you! Our travel experts will contact you shortly.</div>
              </div>
